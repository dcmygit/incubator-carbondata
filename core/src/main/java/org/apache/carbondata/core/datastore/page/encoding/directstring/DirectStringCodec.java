  ...
  public ColumnPageEncoder createEncoder(Map<String, String> parameter) {
    return new ColumnPageEncoder() {
      ...
      protected ColumnPageEncoderMeta getEncoderMeta(ColumnPage inputPage) {
        return new DirectStringEncoderMeta(lengthOfString, compressor.getName());
      }
    };
  }
  ...
  public ColumnPageDecoder createDecoder(ColumnPageEncoderMeta meta) {
    ...
    return new ColumnPageDecoder() {
      ...
      public ColumnPage decode(byte[] input, int offset, int length)
        ...
        return ColumnPage.decompressStringPage(compressor, input, offset, length,
            encoderMeta.getLengthOfString());
      }
    };
  }
}
